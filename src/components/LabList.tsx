  ...
  const labData = [
    {
      ...
      desc: 'Мета: набути практичні навички встановлення й налаштування локального веб-сервера для розробки веб-додатків, ознайомитися з роботою інтегрованого середовища розробки для мови PHP.',
      img: 'Lab 1',
    },
    {
      id: 2,
      title: 'Лабораторна робота №2',
      desc: 'Адаптивна верстка. Використання медіа-запитів, Tailwind CSS.',
      img: 'Lab 2',
    },
    {
      id: 3,
      title: 'Лабораторна робота №3-4',
      desc: 'Основи JavaScript. Робота з DOM, обробка подій, валідація форм.',
      img: 'Lab 3-4',
    },
  ]
