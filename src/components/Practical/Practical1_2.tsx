    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#fde047] to-[#b45309] flex items-center justify-center p-4 font-['Montserrat']">
        <div className="bg-white/10 backdrop-blur-md border border-white/20 p-10 rounded-2xl shadow-2xl text-center max-w-sm w-full transition-transform duration-300">
          ...
          <h5 className="text-xs text-indigo-300 font-semibold mb-6 uppercase tracking-widest">
          ...
          <p className="text-gray-300 text-sm leading-relaxed mb-8">
            ...
            applications, or applications that are run over HTTP from a web
          ...
          <ul className="flex justify-center gap-6">
            <li>
              <a
                href="#"
                className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-600 text-white hover:bg-blue-500 transition-colors shadow-lg"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
            ...
            <li>
              <a
                href="#"
                className="flex items-center justify-center w-10 h-10 rounded-full bg-sky-500 text-white hover:bg-sky-400 transition-colors shadow-lg"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
            ...
            <li>
              <a
                href="#"
                className="flex items-center justify-center w-10 h-10 rounded-full bg-red-600 text-white hover:bg-red-500 transition-colors shadow-lg"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                  <path d="M12.545 10.239v3.821h5.445c-.712 2.315-2.647 3.972-5.445 3.972a5.952 5.952 0 110-11.904c1.464 0 2.753.518 3.791 1.413l2.827-2.827C17.436 3.13 15.228 2.062 12.545 2.062 7.021 2.062 2.544 6.539 2.544 12s4.477 9.938 10.001 9.938c5.445 0 9.456-3.844 9.456-9.67 0-.726-.067-1.428-.194-2.029H12.545z" />
                </svg>
              </a>
            </li>
          </ul>
