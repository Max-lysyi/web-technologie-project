        ...
        <div className="min-h-screen bg-slate-50 font-serif text-gray-900 p-8 pt-12">
            <div className="max-w-6xl mx-auto bg-white p-12 shadow-md rounded border border-gray-100">
                ...
                <header className="mb-6 flex flex-col md:flex-row md:items-baseline md:gap-2">
                    <h1 className="text-2xl font-bold tracking-tight">Футбольний Менеджер</h1>
                    <span className="text-sm italic text-gray-600 font-normal">Офіційний сайт</span>
                </header>
                ...
                <div className="mb-8 text-[15px]">
                    <a href="tel:+380975555501" className="text-blue-700 hover:underline hover:text-blue-800 transition-colors mr-2">+38 (097) 555-55-01</a>
                    <span className="italic text-gray-700">Працюємо 24/7</span>
                </div>

                <div className="w-full h-[400px] overflow-hidden mb-12">
                    <img 
                        src="/football-field-goal-net-grass-stadium-night-time-163455.jpg" 
                ...
                <div className="space-y-5 text-justify leading-[1.8] text-[15.5px] mb-12">
                    ...
                    <p className="italic text-gray-700">Або при вкиданні м'яча. Інші гравці в основному використовують свої ноги, щоб нанести удар або передати м'яч, але можуть також використовувати голову і тулуб.</p>
                </div>
                ...
                <ul className="list-disc list-inside text-blue-700 font-sans space-y-1.5 mb-12 text-sm uppercase font-semibold pl-2">
                    <li><a href="#" className="hover:underline hover:text-blue-900 transition-colors">ОСТАННІ НОВИНИ</a></li>
                    <li><a href="#" className="hover:underline hover:text-blue-900 transition-colors">ПАРІ МАТЧ</a></li>
                    <li><a href="#" className="hover:underline hover:text-blue-900 transition-colors">ПРИВАТНИЙ МЕНЕДЖЕР ВАСЯ</a></li>
                    <li><a href="#" className="hover:underline hover:text-blue-900 transition-colors">ФАНАТИ СЕКТОРУ №48</a></li>
                    <li><a href="#" className="hover:underline hover:text-blue-900 transition-colors">ДОСТАВКА ЇЖІ НА СТАДІОН</a></li>
                </ul>
