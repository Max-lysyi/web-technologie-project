  ...
  const practicalData = [
    {
      ...
      desc: 'Робота з Git та GitHub. Створення репозиторію, базові команди, вирішення конфліктів.',
      img: 'Prac 1',
    },
    {
      id: 2,
      title: 'Практична робота №2',
      desc: 'Налаштування робочого оточення. Встановлення Node.js, робота з npm/yarn, конфігурація Vite.',
      img: 'Prac 2',
    },
    {
      id: 3,
      title: 'Практична робота №3',
      desc: 'Основи роботи з API. Виконання fetch-запитів, обробка промісів, відображення даних.',
      img: 'Prac 3',
    },
  ]
