...
const PracticalList = () => {
  ...
  const practicalData = [
    ...
    },
    {
      ...
      desc: 'Основи програмування сценаріїв веб-сторінки за допомогою мови JavaScript',
      img: 'Prac 5',
    },
    {
      id: 6,
      title: 'Практична робота №6',
      desc: 'Взаємодія з користувачем. Обробка подій і форми',
      img: 'Prac 6',
    },
    {
      id: 7,
      title: 'Практична робота №7',
      desc: 'Адаптивний дизайн веб-сторінок. Технологія Bootstrap',
      img: 'Prac 7',
    },
    {
      id: 8,
      title: 'Практична робота №8',
      desc: 'ОЗНАЙОМЛЕННЯ З МОВОЮ ПРОГРАМУВАННЯ PHP',
      img: 'Prac 8',
    },
    {
      id: 9,
      title: 'Практична робота №9',
      desc: 'Створення односторінкового сайту за допомогою конструктора Weblium',
      img: 'Prac 9',
    }
